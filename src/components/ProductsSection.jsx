...
const ProductCard = ({ title, price, imagePath }) => {
  const isInView = useInView(0.5); // Detects when 50% of the card is in the viewport
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row items-center lg:justify-center py-[140px] lg:py-10">
      ...
      <div className="flex-1 text-left max-w-xl px-8 lg:px-16">
        <p className="text-yellow-500 font-semibold text-xl">WE HELP YOU</p>
        <h1 className="text-5xl font-bold leading-tight mt-2">
          Sell Stunning <br /> Products
        </h1>
      ...
      <div className="flex items-center justify-center gap-16 flex-wrap mt-10 lg:mt-0 lg:ml-16 pt-[260px] lg:pt-0 pb-[50px] lg:pb-0">
        <div className="relative -top-20">
          ...
          <ProductCard
            title="Minimal Chair"
            price="204.00"
            imagePath="../../public/Products/P1.png"
          />
        </div>
        <div className="relative -top-[-130px]">
          ...
          <ProductCard
            ...
            price="74.00"
            imagePath="../../public/Products/P2.png"
          />
        </div>
      </div>
    </div>
